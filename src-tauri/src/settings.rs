...
impl VisibleApps {
    ...
    pub fn is_visible(&self, app: &AppType) -> bool {
        match app {
            ...
            AppType::Lingma => false, // Lingma not yet visible on main page
        }
    }
}
...
pub struct AppSettings {
    ...
    /// 当前 CodeBuddy 供应商 ID（本地存储，保持结构一致）
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub current_provider_codebuddy: Option<String>,
...
pub fn get_current_provider(app_type: &AppType) -> Option<String> {
    ...
    match app_type {
        ...
        AppType::CodeBuddy => settings.current_provider_codebuddy.clone(),
        AppType::Lingma => None, // Lingma doesn't have provider switching
    }
}
...
pub fn set_current_provider(app_type: &AppType, id: Option<&str>) -> Result<(), AppError> {
    ...
    mutate_settings(|settings| match app_type {
        ...
        AppType::CodeBuddy => settings.current_provider_codebuddy = id_owned.clone(),
        AppType::Lingma => {} // Lingma doesn't have provider switching
    })
}
